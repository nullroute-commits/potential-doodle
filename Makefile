...
test:
	...
	while ! pg_isready -h localhost -U app_user; do sleep 1; done
	pytest tests -vv
	docker compose down
...
build-runtime:
	docker build -t ghcr.io/nullroute-commits/django-runtime:$(shell git rev-parse --short HEAD) -f Dockerfile.runtime .
